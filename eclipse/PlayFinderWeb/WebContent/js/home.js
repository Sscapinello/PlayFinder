...
$(function() {
	...
	.done(function(rispostaEventi) {
		...
		$.each(eventi, function(i, evento) {
			...
			'<div class="row input-group margine"><span class="input-group-addon"><i class="glyphicon glyphicon-hand-right"></i></span>' + 
			'<a data-idxevento="' + i + '" class="col-md-6 evento nEvento linkEvento" href="evento.html?='+ evento.idEvento +'">' 
				                 + evento.nome + '</a><p align = "right" class="col-md-6 evento"style="margin-bottom: 40px;">' + evento.squadraCasa.nome + '-' + evento.squadraTrasferta.nome +
